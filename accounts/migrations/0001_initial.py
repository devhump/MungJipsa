# Generated by Django 3.2.13 on 2022-12-07 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dogphoto', imagekit.models.fields.ProcessedImageField(blank=True, default='static/images/입양.png/', upload_to='images/dogphoto/')),
                ('gender', models.CharField(choices=[('수컷', '수컷'), ('암컷', '암컷')], max_length=255)),
                ('neutered', models.CharField(choices=[('O', 'O'), ('X', 'X'), ('?', '?')], max_length=255)),
